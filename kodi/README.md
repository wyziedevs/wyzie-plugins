...
2. Zip the `kodi/` folder as `service.subtitles.wyzie-1.0.3.zip` (the folder must contain `addon.xml`), or install the Wyzie repository from `https://kodi.wyzie.io/repository.wyzie.zip` to get updates automatically.
